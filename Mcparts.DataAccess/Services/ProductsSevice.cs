...
namespace Mcparts.Infrastructure.Services
{
    public class ProductsSevice : IProductsSevice
    {
        ...
        public async Task<List<JObject>> GetAll()
        {
            ...
            cmd.CommandText = Products.GetAll;
        ...
        public async Task<List<JObject>> GetProductsGroupCategory()
        {
            var dataList = new List<JObject>();
            using var cmd = databaseService.McPartsonnection.CreateCommand();
           // cmd.CommandText = Products.GetProductGroupCategories;
            await databaseService.OpenConnection();
            using var reader = await cmd.ExecuteReaderAsync();
        ...
        //    var dataList = new List<JObject>();
        //    using var cmd = databaseService.McPartsonnection.CreateCommand();
        //    cmd.CommandText = Products.GetProductsFilterAllByCategory;
        ...
        //    var dataList = new List<JObject>();
        //    using var cmd = databaseService.McPartsonnection.CreateCommand();
        //    cmd.CommandText = Products.GetProductsFilterAllBySubCategory;
        ...
        //    var dataList = new List<JObject>();
        //    using var cmd = databaseService.McPartsonnection.CreateCommand();
        //    cmd.CommandText = Products.GetProductDataByCategory;
        //    cmd.Parameters.AddWithValue("@productcategoryid", id);
        //    await databaseService.OpenConnection();
        //    using var reader = await cmd.ExecuteReaderAsync();
        ...
        Task<bool> IProductsSevice.Create(ProductsDtoPost data)
        {
            throw new NotImplementedException();
        }

        Task<bool> IProductsSevice.Update(ProductsDto data)
        {
            throw new NotImplementedException();
        }

        Task<List<JObject>> IProductsSevice.Search(JObject filter)
        {
            throw new NotImplementedException();
        }

        Task<List<JObject>> IProductsSevice.GetProductsGroupCategory()
        {
            throw new NotImplementedException();
        }
        ...
        Task<List<JObject>> IProductsSevice.GetProductDataByCategoryWithCount()
        {
            throw new NotImplementedException();
        }

        Task<List<JObject>> IProductsSevice.GetProductDataByCategoryWithCountForMetadata(List<string> ids)
        {
            throw new NotImplementedException();
        }

        Task<List<JObject>> IProductsSevice.GetProductDataBySubCategoryWithCountForMetadata(List<string> ids)
        {
            throw new NotImplementedException();
        }
        ...
        Task<List<JObject>> IBaseHandlerSevice.GetAll()
        {
            throw new NotImplementedException();
        }

        Task<JObject> IBaseHandlerSevice.GetById(string id)
        {
            throw new NotImplementedException();
        }

        Task<bool> IBaseHandlerSevice.Delete(string id)
        {
            throw new NotImplementedException();
        }
    }
